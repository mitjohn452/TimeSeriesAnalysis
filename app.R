...
# Get data from fredr by series_id
...
server <- function(input, output) {
  ...
  output$print_adf <- renderPrint({
    ...
    # STL interpolation for filling missing values
    ts_data_filled <- na.interp(ts_data)
    paste(adf.test(ts_data_filled))
  })
}
